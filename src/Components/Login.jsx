  ...
  const handleForm = (data) => {
    ...
    signIn(email, pass)
      ...
      .catch((error) => {
        ...
        console.log("Invalid Email or Passord");
          ...
          <div className="w-full max-w-md p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
            ...
            <div className="my-6 space-y-4">
              ...
              >
                ...
                <p className="text-[1.2rem] font-lex font-semibold">
                  Login with Google
                </p>
              </button>
            ...
            <div className="flex items-center w-full my-4">
              ...
              <p className="px-3 dark:text-gray-600 text-[1.2rem] font-lex font-semibold">
                OR
              </p>
              <hr className="w-full dark:text-gray-600" />
            </div>
            <form className="card-body" onSubmit={handleSubmit(handleForm)}>
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-[1.2rem] font-lex font-semibold">
                    Email
                  </span>
                </label>
                <input
                  ...
                  {...register("email")}
                  placeholder="Email"
                  className="input input-bordered text-[1.2rem] font-fira font-normal"
                  required
                />
              </div>
              <div className="form-control">
                ...
                <div>
                  {errors.password && (
                    <p className="text-[1.1rem] font-fira font-normal">
              ...
              {
                <p className=" mt-5 text-[1.5rem] fon-fira font-semibold text-red-600">
                  {loginError}
                </p>
              }
              <div className="form-control mt-6">
                <button className="btn btn-primary text-[1.3rem] font-lex font-bold ">
                  Login
                </button>
              </div>
              <p className="text-[1.1rem] font-fira font-normal my-[.8em]">
                Dont have account?{" "}
                <Link to="/register">
                  <span className="underline">Rgister here</span>
                </Link>{" "}
              </p>
            </form>
          </div>

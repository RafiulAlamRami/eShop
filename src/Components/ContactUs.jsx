...
const ContactUs = () => {
	...
	<form noValidate="" className="space-y-6">
		<div>
			<label htmlFor="name" className="text-[1.7rem]">Full name</label>
			<input id="name" type="text" placeholder="" className="border-2 w-full p-3 rounded dark:bg-gray-100" />
		</div>
		<div>
			<label htmlFor="email" className="text-[1.7rem]">Email</label>
			<input id="email" type="email" className=" border-2 w-full p-3 rounded dark:bg-gray-100" />
		</div>
		<div>
			<label htmlFor="message" className="text-[1.7rem]">Message</label>
			<textarea id="message" rows="3" className=" border-2 w-full p-3 rounded dark:bg-gray-100"></textarea>
		</div>
